...
try:
    ...
    from services.mysql_database import MysqlDatabase as Database, DB_TYPES, Singleton, IS_NOT_LINUX
    Database.ENGINE = DB_TYPES.MYSQL
except (ImportError, DatabaseEngineNotFoundError) as ex:
    from services.sqlite_database import SqliteDatabase as Database, DB_TYPES, Singleton, IS_NOT_LINUX
